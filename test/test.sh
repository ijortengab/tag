...
output=$(cat <<-EOF
# This file generated by tag commmand.
 - pop
 - rock
EOF
)
...
tester "tag list './music/GnR/November Rain[love rock].mp3'" -o "$output"
...
tester "tag list ./music/Queen/metadata.tag" -o "$output"
